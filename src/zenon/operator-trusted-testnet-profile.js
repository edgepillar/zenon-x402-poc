...
const DYNAMIC_PLASMA_RESET_EPOCH_POLICY = FREEZE({
  ...
  observeChainTrust:
    context => checkPinnedHeightTwo(DYNAMIC_PLASMA_RESET_EPOCH_SPECIFICATION, context),
});
...
weakSetAdd(OPERATOR_TRUST_POLICIES, DYNAMIC_PLASMA_RESET_EPOCH_POLICY);
...
apply(WEAK_MAP_SET, POLICY_SPECIFICATIONS, [
  DYNAMIC_PLASMA_RESET_EPOCH_POLICY,
  DYNAMIC_PLASMA_RESET_EPOCH_SPECIFICATION,
]);
